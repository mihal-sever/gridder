...
public class KnobButton : MonoBehaviour
{
    ...
    public void Init(float maxPositionX, Action<KnobButton> onSelectedCallback, Action<KnobButton> onDeletedCallback)
    {
    ...
    public void Init(bool isFinished, Vector2 anchoredPosition, float maxPositionX, Action<KnobButton> onSelectedCallback, Action<KnobButton> onDeletedCallback)
    {
        IsFinished = isFinished;
        AnchoredPosition = anchoredPosition;
        Init(maxPositionX, onSelectedCallback, onDeletedCallback);
    }
    ...
    private void ShowCoordinatesPanel()
    {
        ...
        var coordMm = coordPixel / ProjectData.PixelsPerMm;
        _coordToClosestNode = new((int) coordMm.x % ProjectData.GridStepMm, (int) coordMm.y % ProjectData.GridStepMm);
